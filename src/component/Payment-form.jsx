...
function PaymentForm(props) {
    ...
    let ticketNumber = Math.floor((Math.random() * 1000) + 1);

    return (
        <div className='paymentform__container'>
            <div class="iphone">
                <header class="paymentform__header">
                    <h1 className='paymentform__h1'>Trip Details</h1>
                </header>

                <form class="payment__form">
                    <div>
                    <h2 className='paymentform__h2'>Billed to</h2>

                    <div class="payment__card">
                        <address>
                        Name: {props.firstName} {props.lastName}<br />
                        Email: {props.email}<br />
                        Billing Address: {props.address}<br />
                        </address>
                    </div>
                    </div>
                    ...
                    <div class="form__radios">
                        ...
                        <input className='pay__input' checked id="visa" name="payment-method" type="radio" />
                        </div>
                        ...
                        <input className='pay__input' id="paypal" name="payment-method" type="radio" />
                        </div>
                        ...
                        <input className='pay__input' id="mastercard" name="payment-method" type="radio" />
                        </div>
                    </div>
                    </fieldset>

                    <div>
                    <h2 className='paymentform__h2'>Shopping Bill</h2>
                    ...
                    <div>
                    <button class="button__payment button--full" onClick={(e) => openModal(e)}>Pay Now</button>
                    </div>
                </form>
                </div>
                ...
                <Modal isOpen={modal} onRequestClose={closeModal} contentLabel="Bus description">
                    ...
                    <div className='seat__details'>
                        <h3>Your seat has been reserved!</h3>
                        <div className='seat__description'>
                            <p className='seat__title'>Transaction ID: {ticketNumber}</p>
                            <Button className="seat__button" onClick={routeChange}>All Set</Button>
                        </div>
                    </div>
                </Modal>

                <svg xmlnsXlink="http://www.w3.org/2000/svg" className='paymentform__svg'>
